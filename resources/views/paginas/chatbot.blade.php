        ...
        <div class="col-lg-9 col-md-9 col-sm-12 projeto-destaque">
            <div class="row">
                <div class="col-12 destaque-principal">
                    <img class="mx-auto" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914903/site_pessoal/prototipo_chatbot.png" />
                </div>
            </div>
            <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12 secao-texto">
            ...
            <p>O próximo passo era criar um restaurante, público alvo, etc para o exercício. Ao invés disso eu fui em um restaurante que fica perto de casa, o Bentoya, e pedi para que me ajudassem com a pesquisa e se me permitiam usar o restaurante deles como modelo. E eles aceitaram em me ajudar.</p>
                <div class="projeto-imagem">
                    <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914898/site_pessoal/bentoya.png" />
                </div>
        ...
        <div class="row projeto justify-content-center">
            <div class="col-lg-9 col-md-12 col-sm-12  secao-texto">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="projeto-imagem">
                        <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914898/site_pessoal/persona1.png" />
                    </div>
                </div>
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="projeto-imagem">
                        <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914898/site_pessoal/persona2.png" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row projeto justify-content-center">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="projeto-imagem">
                <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914897/site_pessoal/fluxo_inicial.jpg" />
            </div>
        </div>
        <div class="col-lg-9 col-md-12 col-sm-12 secao-texto">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914899/site_pessoal/sketch1.jpg" />
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914901/site_pessoal/sketch2.jpg" />
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12">
                <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914901/site_pessoal/sketch3.jpg" />
            </div>
        </div>
        <div class="row projeto justify-content-center">
            <div class="col-lg-9 col-md-12 col-sm-12 secao-texto">
...
<div class="container">
    <div class="row projeto justify-content-center">
        ...
        <div class="col-12">
            <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914900/site_pessoal/Chatbot-Meshi.png" />
        </div>
        <div class="col-lg-9 col-md-12 col-sm-12 secao-texto">
    ...
    <div class="container">
        <div class="row projeto justify-content-center">
            <div class="col-lg-9 col-md-12 col-sm-12 secao-texto">
                ...
                <div class="projeto-imagem">
                    <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914902/site_pessoal/personabot.png" />
                </div>
                <p>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12  secao-texto">
                <div class="projeto-imagem">
                    <img class="img-100" src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914903/site_pessoal/prototipo_chatbot.png" />
                </div>
                ...
                <div class="projeto-imagem">
                    <img src="https://res.cloudinary.com/dvycanrc8/image/upload/v1533914903/site_pessoal/chatbot-messenger.png" />
                </div>
            </div>
        </div>
    </div>
